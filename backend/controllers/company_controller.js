...
export const registerCompany=async (req,res)=>{
   try {
      ...
      company = await Company.create({
         name:companyName,
         userId:req.id // ----------> dought to get from req.body
      });
      ...
      console.log("register company :",err);
   }
}
...
export const getCompany = async (req,res) => {
   try {
      ...
      console.log('getCompany eror:',err);
   }
...
export const getCompanyById = async (req,res) =>{
   try {
      ...
      console.log('getCompanyById error:',err); 
   }
}
...
export const updateCompany= async (req,res) => {
   try {
      ...
      const updateData= {name,description,website,loaction,logo};
